...
class BottomMenu extends LitElement {
  static get is() { return 'bottom-menu'; }
        ...
        return html`
            ${this.observationData !== undefined ? 
                html`
                    <div class="item">
                        <div class="place">
                            <a @click="${() => this._toggleObservation()}">${this.observationData.weatherStation}</a>
                        </div>
                        <div>
                    ...
                    <div class="item">
                        <div class="temperature">${this.observationData.temperature}°C</div>
                        <weather-symbol-wawa 
